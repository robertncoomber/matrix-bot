...
export function wasm_bindgen__convert__closures__invoke1_mut__h50246dadb17b37a9(a: number, b: number, c: number, d: number): void;
export function wasm_bindgen__convert__closures__invoke0_mut__ha84723bfaa4d4274(a: number, b: number): void;
export function wasm_bindgen__convert__closures__invoke1__h88e11e7e5bf302e4(a: number, b: number, c: number): void;
export function _dyn_core__ops__function__Fn_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h5fc1d5e72f8c3c66(a: number, b: number): void;
export function wasm_bindgen__convert__closures__invoke1_mut__hf520352e3542b71c(a: number, b: number, c: number): void;
export function __wbindgen_free(a: number, b: number): void;
export function __wbindgen_exn_store(a: number): void;
export function wasm_bindgen__convert__closures__invoke2_mut__h25b892f1ba92b9cb(a: number, b: number, c: number, d: number): void;
